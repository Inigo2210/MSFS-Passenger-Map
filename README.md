...
[Flightsim.to page](https://flightsim.to/addon/93874/msfs-passenger-map-an-app-that-emulates-a-passenger-information-screen-and-map)

---

<!-- Add screenshots here once you have them:
<p align="center">
  <img src="screenshots/map.png" width="48%" />
  <img src="screenshots/globe.png" width="48%" />
</p>
-->

## Features

- **Live aircraft tracking** on a 2D Leaflet map and 3D CesiumJS globe
...
```
cp advanced_config.example.txt advanced_config.txt
```
...
```
Access on other device: http://192.168.X.XXX:5000
```
